...
const PortalSection = lazy(() => import('@/app/(portal)/section'));
const PortalSubject = lazy(() => import('@/app/(portal)/subject'));
...
const PortalSpecialClassesSetting = lazy(() => import('@/app/(portal)/special-classes-setting'));
...
const PortalLogin = lazy(() => import('@/app/(auth)/portal'));
...
export const layoutsRoutes = [{
  ...
  path: '/portal/subject',
  name: 'PortalSubject',
  element: <PortalSubject />
}, {
  path: '/portal/subject-teachers',
  ...
  path: '/portal/special-classes-setting',
  name: 'PortalSpecialClassesSetting',
  element: <PortalSpecialClassesSetting />
}, {
  ...
  name: 'PortalStudents',
  element: <PortalStudents />
}, {
  path: '/portal/attendance',
  name: 'PortalAcademicAttendance',
  element: <PortalAcademicAttendance />
}, {
  ...
  path: '/portal/designation',
  name: 'PortalDesignation',
  element: <PortalDesignation />
}, {
  path: '/department',
  name: 'DepartmentRedirect',
  element: <Navigate to="/portal/department" replace />
}, {
  path: '/class',
  name: 'ClassRedirect',
  element: <Navigate to="/portal/class" replace />
}, {
  path: '/section',
  name: 'SectionRedirect',
  element: <Navigate to="/portal/section" replace />
}, {
  path: '/subject',
  name: 'SubjectRedirect',
  element: <Navigate to="/portal/subject" replace />
}, {
  ...
  path: '/students',
  name: 'StudentsRedirect',
  element: <Navigate to="/portal/students" replace />
}, {
  path: '/classroom',
  name: 'ClassroomRedirect',
  element: <Navigate to="/portal/classroom" replace />
}, {
  path: '/designation',
  name: 'DesignationRedirect',
  element: <Navigate to="/portal/designation" replace />
}, {
  path: '/employee',
  name: 'Employee',
