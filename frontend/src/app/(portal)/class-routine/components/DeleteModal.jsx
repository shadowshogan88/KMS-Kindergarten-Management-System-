...
const closeRoutineDeleteOverlay = () => closeOverlay('#academic-routine-delete-modal');

const DeleteModal = ({ routine, onConfirm }) => {
  ...
  return (
    <div
      id="academic-routine-delete-modal"
      className="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto pointer-events-none"
      role="dialog"
      tabIndex={-1}
      aria-labelledby="academic-routine-delete-modal-label"
    >
        ...
        <div className="w-full flex flex-col card shadow-2xs border border-default-200 rounded-xl pointer-events-auto px-6 py-8 relative">
          <div className="absolute top-3 end-3">
            <button
              ...
              aria-label="Close"
              data-hs-overlay="#academic-routine-delete-modal"
              onClick={closeRoutineDeleteOverlay}
          ...
          <h3 className="font-semibold text-base text-default-800 text-center">
            ...
            <div className="mt-5 text-center">
              ...
              <p className="text-default-500 text-sm font-normal">Delete routine{routine?.id ? ` #${routine.id}` : ''}?</p>
              ...
              <div className="mt-5 flex gap-2 justify-center">
                ...
                <button className="bg-danger text-white btn border-0 btn-sm" onClick={submit} disabled={isSubmitting || !routine}>
                  Yes,Delete It!
                </button>
              </div>
            </div>
