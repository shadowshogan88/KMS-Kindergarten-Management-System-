...
const closeDesignationDeleteOverlay = () => closeOverlay('#designation-delete-modal');

const DeleteModal = ({ designation, onConfirm }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      tabIndex={-1}
      aria-labelledby="designation-delete-modal-label"
    >
        ...
        <div className="w-full flex flex-col card shadow-2xs border border-default-200 rounded-xl pointer-events-auto px-6 py-8 relative">
          <div className="absolute top-3 end-3">
            <button
              ...
              aria-label="Close"
              data-hs-overlay="#designation-delete-modal"
              onClick={closeDesignationDeleteOverlay}
          ...
          <h3 className="font-semibold text-base text-default-800 text-center">
            ...
            <div className="mt-5 text-center">
              ...
              <p className="text-default-500 text-sm font-normal">
                Delete designation{designation?.title ? ` “${designation.title}”` : ''}?
              </p>
              ...
              <div className="mt-5 flex gap-2 justify-center">
                ...
                <button className="bg-danger text-white btn border-0 btn-sm" onClick={submit} disabled={isSubmitting || !designation}>
                  Yes,Delete It!
                </button>
              </div>
            </div>
