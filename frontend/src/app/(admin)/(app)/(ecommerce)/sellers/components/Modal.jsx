...
const Modal = () => {
  return <div id="ecommerce-sellers-add" className="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto pointer-events-none hs-overlay-open:pointer-events-auto" role="dialog" tabIndex={-1} aria-labelledby="ecommerce-sellers-add-label">
